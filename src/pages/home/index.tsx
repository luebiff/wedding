  ...
  return (
    <>
      ...
      <div className="grid grid-cols-2 gap-2 mb-10 p-10">
        <div>
          <h2 className="text-3xl font-OleoScript">Vi ska gifta oss! </h2>
          <p className="text-xl mb-3">Äntligen bröllop!</p>
          <p>
          ...
          <p>
            ...
            ställe för att underlätta för oss alla. Här finner du information om
            vigsel, fest, boende och praktiska detaljer och lite annat som ni
