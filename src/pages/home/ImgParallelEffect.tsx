...
const ImgParallelEffect = () => {
  return (
    <div className="parallax">
      <img className=" img1 w-60 h-w-60" src={Img1}></img>
      <img className=" img2 w-60 h-w-60" src={Img2}></img>
      <img className=" img3 w-60 h-w-60" src={Img3}></img>
      <img className=" img4 w-60 h-w-60" src={Img4}></img>
      <img className=" img5 w-60 h-w-60" src={Img5}></img>
      <img className=" img6 w-60 h-w-60" src={Img6}></img>
      <img className=" img7 w-60 h-w-60" src={Img7}></img>
    </div>
  );
};
